...
struct Parameters {
	...
	double steady_halt; 	// halt the run if a steady solution is found
	double CFLmin;  		// minimum allowable CFL number
	double CFLmax;			// maximum alloweable CFL number
	int dynamic_stepping;  	// option to update the step size to be in line with desired CFL range
};
